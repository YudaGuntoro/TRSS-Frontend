...
export default function ParameterTable() {
  ...
  const { can } = useAuth();
  const canCreate = can(PERMISSIONS.PARAMETER_CREATE);
  const canEdit = can(PERMISSIONS.PARAMETER_EDIT);
  const canDelete = can(PERMISSIONS.PARAMETER_DELETE);
      ...
      ? [
          {
            ...
            render: (_: unknown, row: Parameter) => (
