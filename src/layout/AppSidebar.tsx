    ...
    >
      ...
      >
        <Link href="/" className="sidebar-brand-link flex items-center gap-3">
          <span className="sidebar-brand-motion flex items-center gap-3">
            {isExpanded || isHovered || isMobileOpen ? (
              <>
                ...
                <Image
                  ...
                  height={60}
                />
                <span className="text-gray-800 dark:text-white/90 font-bold text-sm leading-snug">
                  Tokyo Radiator <br /> Selamat Sempurna
                </span>
              </>
            ) : (
              <Image
